...
export default function PromiseStrip() {
  return (
    <section className="px-6 pb-8">
      <div className="max-w-6xl mx-auto bg-card rounded-2xl border border-line px-8 py-9 grid md:grid-cols-[minmax(0,0.9fr)_minmax(0,2fr)] gap-8 items-center">
        <div>
          ...
          <h3 className="font-display font-normal text-ink text-[28px] leading-[1.15] tracking-[-0.025em]">
            Kindness today.
            <br />
            Hope forever. <span className="text-accent">♡</span>
          </h3>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-line">
          {stats.map(({ icon: Icon, value, label }) => (
            <div key={label} className="px-5 text-center first:pl-0">
              <Icon className="text-accent mx-auto mb-2" size={22} strokeWidth={1.6} />
