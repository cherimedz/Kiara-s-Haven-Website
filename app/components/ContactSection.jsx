...
export default function ContactSection() {
  return (
    <>
      ...
      <section id="contact" className="relative bg-brand-soft px-6 pt-4 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto grid md:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
          <div>
            ...
            <Eyebrow className="text-warm mb-3">Let&apos;s stay connected</Eyebrow>
            <h2 className="font-display font-normal text-ink text-[clamp(2rem,3vw,2.5rem)] leading-[1.08] tracking-[-0.025em] mb-3">
              Leave something
              <br />
              kind behind.
            </h2>
            <p className="text-[17px] leading-[1.7] text-warm mb-6">
